...
floaterfile=pkg_resources.resource_filename(__name__,"data/floater.txt");
...
class WEC():
    #number of states
    states=10;
    file=floaterfile;#Path(__file__).parent()/"floater.txt";
    acc=0;
    force_sensor=0;
    ...
    def load_buoy(self,xi,depth,cog):
        self.buoy=fl(xi,g,depth,cog,self.file);
